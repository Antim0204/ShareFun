    ...
    try{
        ...
        if(newVerifiedEmail){
            ...
            .then(()=>{
                res.status(201).send({
                    success:"Pending",
                    message:"Verification email has been sent to your account.Check your email for further information"
                });
            })
            .catch((err)=>{
                console.log(err);
        ...
        if (resetEmail){
            transporter
                ...
                .then(()=>{
                        res.status(201).send({
                        success:"PENDING",
                        message:"Reset Password Link has beeb sent to your Account",
