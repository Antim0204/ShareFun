...
import { CustomButtton, Loading, TextInput } from '../components';
  ...
  return (
    <div className='bg-bgColor w-full h-[100vh] flex items-center justify-center p-6'>
      ...
      <div className='w-full lg:w-1/2 h-full p-10 2xl:px-20 flex flex-col justify-center'>
        <div className='w-full flex gap-2 items-cneter mb-6'>
        ...
        <span className='text-sm mt-2 text-ascent-2'>Welconme back</span>
