...
import { CustomButtton, EditProfile, FriendsCard, Loading, PostCard, ProfileCard, TextInput, TopBar } from '../components';
...
<div className='home w-full px-0 lg:px-10 pb-20 2xl:px-40
  bg-bgColor lg:rounded-lg h-screen overflow-hidden'>
    <TopBar/>
    ...
    <div className='hidden w-1/4 h-full lg:flex flex-col gap-8 overflow-y-auto'>
      ...
      <div className='w-full bg-primary shadow-sm rounded-lg px-6 py-5'>
        <div className='flex items-center justify-between text-xl text-ascent-1 pb-2 border-2 border-[#66666645]'>
...

          {
            friendRequest?.map(({_id,requestFrom:from})=>(
              ...
              <div className='flex gap-1'>
                ...
                containerStyles='bg-[#666] text-xs text-ascent px-1.5 py-1 rounded-full'
                />
