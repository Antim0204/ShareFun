    ...
    </p>
{
  post?.image && (
    ...
    <div className='mt-4 flex justify-between items-center px-3 py-2 text-ascent-2 text-base border-t border-[#66666645]'>
      <p
      className='flex-gap-2 items-center text-base cursor cursor-pointer'
          ...
          />
          {
            loading ? (<Loading/>):
              comments?.length > 0? (
                comments?.map((comment)=>(
                  <div className='w-full py-2 ' key={comment?._id}>
                    ...
                    <div className='py-2 px-8 mt-6'>
                      ...
                      {
                        showReply===comment?.replies?._id && comment?.replies?.
                        map((reply)=>(
                          <ReplyCard 
                          reply={reply} 
                          user={user}
               ...
               <span className='flex tezt-sm py-4 text-ascent-2 text-center'>
